...
; Swap badges 3 (PlainBadge) and 5 (MineralBadge).
	...
	ld c, a
	ld a, d
	and ((1 << ANCHORBADGE) | (1 << CRUSHBADGE) | (1 << FOGBADGE) | (1 << STORMBADGE) | (1 << GLACIERBADGE) | (1 << RISINGBADGE))
	or b
	or c
	ld b, a
...
.ev_loop
	...
	add a
.no_pokerus_boost
; Make sure total EVs never surpass 600
	push bc
	push hl
	ld d, a
	ld a, c
...
IsEvsGreaterThan600:
; Total EVs in bc. Set Carry flag if bc > 600.
