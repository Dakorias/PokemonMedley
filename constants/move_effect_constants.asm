; MoveEffectsPointers indexes (see data/moves/effects_pointers.asm)
	...
	const EFFECT_DARK_VOID
	const EFFECT_CHARGE_BEAM
	const EFFECT_ERUPTION
	const EFFECT_WILL_O_WISP
	const EFFECT_DEFOG
	const EFFECT_BRINE
	const EFFECT_KNOCK_OFF
	const EFFECT_TRICK_ROOM
	const EFFECT_COSMIC_POWER
	const EFFECT_SP_ATK_DOWN_2_USER
	const EFFECT_AVALANCHE
	const EFFECT_HAIL
	const EFFECT_BLAST_BURN
	const EFFECT_HYDRO_CANNON
	const EFFECT_FRENZY_PLANT
	const EFFECT_TAILWIND
	const EFFECT_BANEFULBUNKR
	const EFFECT_BULK_UP
	const EFFECT_TAUNT
	const EFFECT_COIL
	const EFFECT_PHANTOMFORCE
