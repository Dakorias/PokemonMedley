...
; wVisitedSpawns
	const ENGINE_FLYPOINT_HERALD_PORT
	const ENGINE_FLYPOINT_HERALD_COVE
	const ENGINE_FLYPOINT_CRAGGY_COAST
	const ENGINE_FLYPOINT_RUGGED_CLIFF
	const ENGINE_FLYPOINT_TREELINE_PORT
	const ENGINE_FLYPOINT_MONTANE_TOWN
...
; wDailyFlags2
	...
	const ENGINE_BERRY_FOREST_MASTER_BERRIES
