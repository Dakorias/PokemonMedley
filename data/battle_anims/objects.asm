...
; BATTLE_ANIM_OBJ_ROCK_BLAST
	battleanimobj RELATIVE_X, $ff, BATTLE_ANIM_FRAMESET_BIG_ROCK, BATTLE_ANIM_FUNC_THROW_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BROWN, BATTLE_ANIM_GFX_ROCKS
; BATTLE_ANIM_OBJ_SILVER_WIND
	battleanimobj RELATIVE_X, $80, BATTLE_ANIM_FRAMESET_CIRCLING_SPARKLE, BATTLE_ANIM_FUNC_USER_TO_TARGET_SPIN, PAL_BATTLE_OB_YELLOW, BATTLE_ANIM_GFX_SPEED
; BATTLE_ANIM_OBJ_SAND_TOMB
	battleanimobj RELATIVE_X, $98, BATTLE_ANIM_FRAMESET_POWDER, BATTLE_ANIM_FUNC_SACRED_FIRE, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_POWDER
; BATTLE_ANIM_OBJ_STONE_EDGE
	battleanimobj RELATIVE_X, $b0, BATTLE_ANIM_FRAMESET_BIG_ROCK, BATTLE_ANIM_FUNC_RAPID_SPIN, PAL_BATTLE_OB_BROWN, BATTLE_ANIM_GFX_ROCKS
; BATTLE_ANIM_OBJ_BULLET_SEED
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $68,  BATTLE_ANIM_FRAMESET_LEECH_SEED_1, BATTLE_ANIM_FUNC_NEEDLE, PAL_BATTLE_OB_GREEN, BATTLE_ANIM_GFX_PLANT
; BATTLE_ANIM_OBJ_ROCK_TOMB
	battleanimobj RELATIVE_X, $b0, BATTLE_ANIM_FRAMESET_STRENGTH, BATTLE_ANIM_FUNC_DROP, PAL_BATTLE_OB_BROWN, BATTLE_ANIM_GFX_ROCKS
; BATTLE_ANIM_OBJ_DEFOG
	battleanimobj RELATIVE_X | X_FLIP | PRIORITY, $88, BATTLE_ANIM_FRAMESET_MIST, BATTLE_ANIM_FUNC_AGILITY, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_HAZE
