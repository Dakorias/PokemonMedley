...
MapGroup_HeraldCove:
	...
	map HeraldGrotto, TILESET_JOHTO, ROUTE, LANDMARK_HERALD_ROUTE, MUSIC_LIGHTHOUSE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map RuggedCliffGrotto, TILESET_JOHTO, ROUTE, LANDMARK_RUGGED_CLIFF, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_CraggyCoast:
	...
	map MountainGymBreak, TILESET_TOWER, INDOOR, LANDMARK_MT_MONEGO, MUSIC_GYM, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MountainGymArena, TILESET_TOWER, INDOOR, LANDMARK_MT_MONEGO, MUSIC_GYM, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_BerryForest:
	...
	map HeraldBayGrotto, TILESET_JOHTO, ROUTE, LANDMARK_HERALD_BAY, MUSIC_ROUTE_29, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	assert_table_length NUM_BERRY_FOREST_MAPS

MapGroup_SecondIsland:
	table_width MAP_LENGTH, MapGroup_SecondIsland
	map TreelinePort, TILESET_JOHTO, TOWN, LANDMARK_TREELINE_PORT, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map TreelinePortInside, TILESET_PORT, INDOOR, LANDMARK_TREELINE_PORT, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_OCEAN
	map ForestPark, TILESET_JOHTO, ROUTE, LANDMARK_FOREST_PARK, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
