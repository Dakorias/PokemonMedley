...
; HYPER_POTION
	item_attribute 1200, HELD_NONE, 200, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; SUPER_POTION
...
; REPEL
	item_attribute 100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; MAX_ELIXER
...
; SUPER_REPEL
	item_attribute 150, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; MAX_REPEL
	item_attribute 300, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; DIRE_HIT
...
; PSNCUREBERRY
	item_attribute 200, HELD_HEAL_POISON, 0, CANT_SELECT, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; GOLD_LEAF
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SOFT_SAND
...
; PRZCUREBERRY
	item_attribute 250, HELD_HEAL_PARALYZE, 0, CANT_SELECT, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; BURNT_BERRY
	item_attribute 200, HELD_HEAL_FREEZE, 0, CANT_SELECT, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; ICE_BERRY
	item_attribute 150, HELD_HEAL_BURN, 0, CANT_SELECT, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; POISON_BARB
...
; BITTER_BERRY
	item_attribute 200, HELD_HEAL_CONFUSION, 0, CANT_SELECT, BERRIES, ITEMMENU_NOUSE, ITEMMENU_PARTY
; MINT_BERRY
	item_attribute 300, HELD_HEAL_SLEEP, 0, CANT_SELECT, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; RED_APRICORN
...
; BLU_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, BERRIES, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CANDY_BAG
	item_attribute 4800, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; AMULET_COIN
...
; MIRACLEBERRY
	item_attribute 400, HELD_HEAL_STATUS, 0, CANT_SELECT, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; PEARL
...
; BERRY_JUICE
	item_attribute 400, HELD_BERRY, 20, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; SCOPE_LENS
...
; DREAM_BERRY
	item_attribute 500, HELD_BERRY, 30, CANT_SELECT, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; TEACHY_TV
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; LIGHT_CLAY
	item_attribute 100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MYSTERYBERRY
	item_attribute 250, HELD_RESTORE_PP, -1, CANT_SELECT, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; DRAGON_SCALE
...
; LOVE_BALL
	item_attribute 150, HELD_NONE, 0, CANT_SELECT, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; RAZOR_CLAW
	item_attribute 100, HELD_CRITICAL_UP, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CHOICE_SPECS
	item_attribute 100, HELD_CHOICE_BOOST, SP_ATTACK, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SUN_STONE
	item_attribute 2100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; CHOICE_SCARF
	item_attribute 100, HELD_CHOICE_BOOST, SPEED, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; WIDE_LENS
	item_attribute 100, HELD_ACCURACY_BOOST, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; UP_GRADE
	item_attribute 2100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BERRY
	item_attribute 150, HELD_BERRY, 10, CANT_SELECT, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; GOLD_BERRY
	item_attribute 500, HELD_BERRY, 30, CANT_SELECT, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; SQUIRTBOTTLE
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; BLACK_SLUDGE
	item_attribute 100, HELD_BLACK_SLUDGE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PARK_BALL
	item_attribute 0, HELD_NONE, 0, CANT_SELECT, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; RAINBOW_WING
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ROCKY_HELMET
	item_attribute 100, HELD_ROCKY_HELMET, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BRICK_PIECE
	item_attribute 50, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; FOCUS_SASH
	item_attribute 100, HELD_FOCUS_SASH, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LIFE_ORB
	item_attribute 100, HELD_LIFE_ORB, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; METRONOME_I
	item_attribute 100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LOADED_DICE
	item_attribute 100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; WHITE_HERB
	item_attribute 100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MUSCLE_BAND
	item_attribute 100, HELD_CATEGORY_BOOST, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SHELL_BELL
	item_attribute 100, HELD_SHELL_BELL, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; WISE_GLASSES
	item_attribute 100, HELD_CATEGORY_BOOST, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; WKNESSPOLICY
	item_attribute 100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CHOICE_BAND
	item_attribute 100, HELD_CHOICE_BOOST, ATTACK, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
