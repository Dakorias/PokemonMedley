...
BattleAnim_BlazeKick:
	...
	anim_obj BATTLE_ANIM_OBJ_FIRE_BLAST, 136, 48, $2
	anim_obj BATTLE_ANIM_OBJ_FIRE_BLAST, 136, 48, $3
...
BattleAnim_OminousWind:
	anim_2gfx BATTLE_ANIM_GFX_HIT, BATTLE_ANIM_GFX_HAZE
	anim_bgp $1b
	anim_obp1 $1b
	anim_obj BATTLE_ANIM_OBJ_DEFOG, 8, 24, $10
	anim_obj BATTLE_ANIM_OBJ_DEFOG, 8, 48, $2
	anim_obj BATTLE_ANIM_OBJ_DEFOG, 8, 88, $8
	anim_wait 4
	anim_obj BATTLE_ANIM_OBJ_DEFOG, 8, 32, $6
	anim_obj BATTLE_ANIM_OBJ_DEFOG, 8, 56, $c
	anim_obj BATTLE_ANIM_OBJ_DEFOG, 8, 80, $4
	anim_obj BATTLE_ANIM_OBJ_DEFOG, 8, 104, $e
...
BattleAnim_Bide:
	anim_if_param_equal $0, BattleAnim_Flatter
	anim_1gfx BATTLE_ANIM_GFX_HIT
	anim_call BattleAnim_TargetObj_1Row
...
BattleAnim_Uturn:
	anim_2gfx BATTLE_ANIM_GFX_SPEED, BATTLE_ANIM_GFX_HIT, BATTLE_ANIM_GFX
...
.loop
	anim_sound 0, 1, SFX_STRENGTH
	anim_bgeffect BATTLE_BG_EFFECT_FLASH_INVERTED, $0, $8, $2
	anim_obj BATTLE_ANIM_OBJ_STONE_EDGE, 120, 80, $40
	anim_wait 3
	anim_obj BATTLE_ANIM_OBJ_HIT_YFIX, 136, 45, $0
	anim_obj BATTLE_ANIM_OBJ_STONE_EDGE, 152, 80, $30
	anim_wait 3
	anim_sound 0, 1, SFX_STRENGTH
	anim_obj BATTLE_ANIM_OBJ_STONE_EDGE, 140, 80, $30
	anim_obj BATTLE_ANIM_OBJ_HIT_YFIX, 128, 50, $0
	anim_wait 3
	anim_sound 0, 1, SFX_STRENGTH
	anim_obj BATTLE_ANIM_OBJ_STONE_EDGE, 144, 80, $40
	anim_wait 3
	anim_sound 0, 1, SFX_STRENGTH
	anim_obj BATTLE_ANIM_OBJ_STONE_EDGE, 132, 80, $30
...
BattleAnim_ShadowSneak:
	anim_2gfx BATTLE_ANIM_GFX_HAZE, BATTLE_ANIM_GFX_HIT
	anim_bgeffect BATTLE_BG_EFFECT_BLACK_HUES, $0, $8, $0
.loop
	anim_obj BATTLE_ANIM_OBJ_POISON_GAS, 44, 110, $6
	anim_sound 0, 1, SFX_POISON_STING
	anim_wait 3
	anim_loop 7, .loop
	anim_wait 65
	...
	anim_wait 7
	anim_sound 0, 1, SFX_BEAT_UP
	anim_obj BATTLE_ANIM_OBJ_HIT_YFIX, 136, 50, $0
	anim_wait 7
	anim_sound 0, 1, SFX_BEAT_UP
	anim_obj BATTLE_ANIM_OBJ_HIT_YFIX, 130, 52, $0
	anim_wait 12
	anim_ret

BattleAnim_IronDefense:
	anim_2gfx BATTLE_ANIM_GFX_REFLECT, BATTLE_ANIM_GFX_SHINE
...
BattleAnim_DracoMeteor:
	anim_3gfx BATTLE_ANIM_GFX_SHINE, BATTLE_ANIM_GFX_ROCKS, BATTLE_ANIM_GFX_HIT
	...
	anim_wait 60
	anim_incbgeffect BATTLE_BG_EFFECT_CYCLE_MON_LIGHT_DARK_REPEATING
	anim_obj BATTLE_ANIM_OBJ_SMALL_ROCK, 88, 0, $2
...
BattleAnim_ThunderFang:
	anim_2gfx BATTLE_ANIM_GFX_CUT, BATTLE_ANIM_GFX_LIGHTNING
	anim_obj BATTLE_ANIM_OBJ_BITE, 136, 56, $98
	anim_obj BATTLE_ANIM_OBJ_BITE, 136, 56, $18
	anim_wait 8
	anim_bgeffect BATTLE_BG_EFFECT_FLASH_INVERTED, $0, $8, $2
...
.loop
	anim_obj BATTLE_ANIM_OBJ_BULLET_SEED, 64, 92, $18
	anim_wait 4
	anim_obj BATTLE_ANIM_OBJ_BULLET_SEED, 56, 84, $18
	anim_sound 0, 1, SFX_PECK
	anim_obj BATTLE_ANIM_OBJ_HIT_SMALL, 136, 56, $0
	anim_wait 4
	anim_obj BATTLE_ANIM_OBJ_BULLET_SEED, 52, 88, $18
	anim_sound 0, 1, SFX_PECK
	anim_obj BATTLE_ANIM_OBJ_HIT_SMALL, 128, 48, $0
	anim_wait 4
	anim_sound 0, 1, SFX_PECK
...
BattleAnim_EarthPower:
	...
	anim_bgeffect BATTLE_BG_EFFECT_FLASH_INVERTED, $0, $8, $2
	anim_bgeffect BATTLE_BG_EFFECT_SHAKE_SCREEN_X, $10, $1, $0
	anim_obj BATTLE_ANIM_OBJ_EMBER, 116, 68, $30
	anim_obj BATTLE_ANIM_OBJ_ROCK_SMASH, 116, 64, $28
	anim_obj BATTLE_ANIM_OBJ_ROCK_SMASH, 116, 64, $10
	anim_obj BATTLE_ANIM_OBJ_ROCK_SMASH, 116, 64, $9c
	anim_obj BATTLE_ANIM_OBJ_ROCK_SMASH, 116, 64, $dc
	anim_wait 16
	anim_clearobjs
	anim_wait 6
	anim_sound 0, 0, SFX_EGG_BOMB
	anim_bgeffect BATTLE_BG_EFFECT_FLASH_INVERTED, $0, $8, $2
	anim_bgeffect BATTLE_BG_EFFECT_SHAKE_SCREEN_X, $10, $1, $0
	anim_obj BATTLE_ANIM_OBJ_EMBER, 152, 68, $30
	anim_obj BATTLE_ANIM_OBJ_ROCK_SMASH, 152, 64, $28
	anim_obj BATTLE_ANIM_OBJ_ROCK_SMASH, 152, 64, $5c
	anim_obj BATTLE_ANIM_OBJ_ROCK_SMASH, 152, 64, $10
	anim_obj BATTLE_ANIM_OBJ_ROCK_SMASH, 152, 64, $dc
	anim_wait 16
	anim_clearobjs
	anim_wait 6
	anim_sound 0, 0, SFX_EGG_BOMB
	anim_bgeffect BATTLE_BG_EFFECT_FLASH_INVERTED, $0, $8, $2
	anim_bgeffect BATTLE_BG_EFFECT_SHAKE_SCREEN_X, $10, $1, $0
	anim_obj BATTLE_ANIM_OBJ_EMBER, 128, 68, $30
	...
	anim_bgeffect BATTLE_BG_EFFECT_FLASH_INVERTED, $0, $8, $2
	anim_bgeffect BATTLE_BG_EFFECT_SHAKE_SCREEN_X, $10, $1, $0
	anim_obj BATTLE_ANIM_OBJ_EMBER, 140, 68, $30
	anim_obj BATTLE_ANIM_OBJ_ROCK_SMASH, 140, 64, $10
	anim_obj BATTLE_ANIM_OBJ_ROCK_SMASH, 140, 64, $1c
	anim_obj BATTLE_ANIM_OBJ_ROCK_SMASH, 140, 64, $50
	anim_obj BATTLE_ANIM_OBJ_ROCK_SMASH, 140, 64, $90
	anim_wait 32
	anim_ret
...
.alternate:
	...
	anim_wait 4
	anim_sound 0, 1, SFX_KARATE_CHOP
	anim_obj BATTLE_ANIM_OBJ_PALM, 120, 64, $0
	anim_wait 6
	anim_obj BATTLE_ANIM_OBJ_HIT_YFIX, 120, 64, $0
	anim_wait 8
	anim_call BattleAnim_ShowMon_0
...
BattleAnim_SandTomb:
	...
	.loop
		anim_sound 0, 0, SFX_MENU
		anim_obj BATTLE_ANIM_OBJ_SAND_TOMB, 132, 72, $0
		anim_wait 7
		anim_loop 12, .loop
	anim_incbgeffect BATTLE_BG_EFFECT_WOBBLE_MON
	anim_call BattleAnim_ShowMon_1
...
BattleAnim_GunkShot:
	anim_3gfx BATTLE_ANIM_GFX_EGG, BATTLE_ANIM_GFX_POISON, BATTLE_ANIM_GFX_HIT
	anim_bgeffect BATTLE_BG_EFFECT_BLACK_HUES, $0, $8, $0
	anim_bgeffect BATTLE_BG_EFFECT_SHAKE_SCREEN_X, $40, $2, $0
	anim_wait 50
.loop
	...
	anim_wait 6
	anim_sound 6, 2, SFX_SLUDGE_BOMB
	anim_obj BATTLE_ANIM_OBJ_SLUDGE_BOMB, 56, 84, $10
	anim_wait 7
	anim_sound 6, 2, SFX_SLUDGE_BOMB
	anim_obj BATTLE_ANIM_OBJ_SLUDGE_BOMB, 52, 88, $10
	anim_wait 5
	anim_loop 3, .loop
	anim_call BattleAnimSub_Sludge
	anim_wait 56
...
.loop
	anim_sound 0, 0, SFX_MENU
	anim_obj BATTLE_ANIM_OBJ_SILVER_WIND, 60, 88, $4
	anim_wait 6
	anim_obj BATTLE_ANIM_OBJ_SILVER_WIND, 66, 68, $4
	anim_wait 6
	anim_sound 0, 0, SFX_MENU
	anim_obj BATTLE_ANIM_OBJ_SILVER_WIND, 72, 78, $4
	anim_wait 6
	anim_obj BATTLE_ANIM_OBJ_SILVER_WIND, 80, 56, $4
	anim_wait 8
	anim_loop 3, .loop
	anim_sound 0, 0, SFX_MENU
	anim_wait 64
...
BattleAnim_Accelerock:
	anim_3gfx BATTLE_ANIM_GFX_SPEED, BATTLE_ANIM_GFX_HIT, BATTLE_ANIM_GFX_ROCKS
	anim_sound 0, 0, SFX_MENU
	anim_bgeffect BATTLE_BG_EFFECT_HIDE_MON, $0, BG_EFFECT_USER, $0
	anim_obj BATTLE_ANIM_OBJ_SPEED_LINE, 24, 88, $2
	anim_obj BATTLE_ANIM_OBJ_SPEED_LINE, 32, 88, $1
	...
	anim_bgeffect BATTLE_BG_EFFECT_TACKLE, $0, BG_EFFECT_USER, $0
	anim_wait 4
	anim_obj BATTLE_ANIM_OBJ_ROCK_BLAST, 64, 92, $10
	anim_wait 29
	anim_clearobjs
	anim_wait 1
	anim_sound 0, 1, SFX_TACKLE
	anim_obj BATTLE_ANIM_OBJ_HIT_YFIX, 124, 54, $0
	anim_call BattleAnim_ShowMon_0
	anim_wait 8
	anim_ret
	...
	anim_incbgeffect BATTLE_BG_EFFECT_FADE_MON_TO_BLACK
	anim_sound 0, 0, SFX_METRONOME
	anim_obj BATTLE_ANIM_OBJ_FORESIGHT, 54, 88, $0
	anim_wait 2
	anim_obj BATTLE_ANIM_OBJ_FORESIGHT, 64, 78, $0
	anim_wait 2
	anim_obj BATTLE_ANIM_OBJ_FORESIGHT, 74, 68, $0
	anim_wait 12
	anim_call BattleAnim_ShowMon_0
	anim_ret
	...
	anim_wait 12
	anim_bgeffect BATTLE_BG_EFFECT_SHAKE_SCREEN_X, $10, $1, $20
	anim_wait 20
	anim_sound 0, 1, SFX_STRENGTH
	anim_obj BATTLE_ANIM_OBJ_ROCK_TOMB, 133, 68, $30
	anim_wait 12
	anim_bgeffect BATTLE_BG_EFFECT_SHAKE_SCREEN_X, $10, $1, $20
	anim_wait 20
	anim_sound 0, 1, SFX_STRENGTH
	anim_obj BATTLE_ANIM_OBJ_ROCK_TOMB, 146, 64, $30
	anim_wait 12
	anim_bgeffect BATTLE_BG_EFFECT_SHAKE_SCREEN_X, $10, $1, $20
	anim_wait 96
	anim_ret
